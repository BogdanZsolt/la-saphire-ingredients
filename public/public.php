...
function lasaphire_ingredients_public_styles_scripts(){
	...
	wp_enqueue_style( 'lasaphire-ingredients-public-style', LASAPHIRE_INGREDIENTS_URL . 'public/public.css', '', rand());
	wp_enqueue_script( 'lasaphire-ingredients-public-script', LASAPHIRE_INGREDIENTS_URL . 'public/public.js', array(), rand(), true );
}
